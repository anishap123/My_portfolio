        ...
        <div className="About flex flex-col ">
          ...
          <div className=" py-4 ml-2   w-[98%] flex  justify-between  ">
            <div className="flex  w-[35%] flex-col  shadow rounded-md bg-slate-100">
              ...
              <h2 className="ml-4 text-[#54595F] font-semibold text-[22px]">Anisha Poudel</h2>
              ...
              <p className="ml-3 text-[#54595F] text-[14px]">9865316914</p>
              </span>
              <span className="flex flex-row ml-4 mt-1">
              <FaMailBulk className="text-[#4c7753] mt-1"/>
              <p className="ml-3 text-[14px] text-[#54595F] mr-1">anishapoudel570@gmail.com</p>
              </span>
              <h2 className="ml-4 text-[#54595F]  text-[16px] mt-4">FIND  WITH ME</h2>
              <span className="flex flex-row ml-2 mt-1 gap-5 mb-4 p-2">
